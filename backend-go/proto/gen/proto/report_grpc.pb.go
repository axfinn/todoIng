...
const (
	ReportService_GetReports_FullMethodName     = "/todoing.ReportService/GetReports"
	ReportService_GetReport_FullMethodName      = "/todoing.ReportService/GetReport"
	ReportService_GenerateReport_FullMethodName = "/todoing.ReportService/GenerateReport"
	ReportService_PolishReport_FullMethodName   = "/todoing.ReportService/PolishReport"
	ReportService_ExportReport_FullMethodName   = "/todoing.ReportService/ExportReport"
	ReportService_DeleteReport_FullMethodName   = "/todoing.ReportService/DeleteReport"
)
...
type ReportServiceClient interface {
	...
	// 润色报告
	PolishReport(ctx context.Context, in *PolishReportRequest, opts ...grpc.CallOption) (*PolishReportResponse, error)
	// 导出报告
...
func (c *reportServiceClient) PolishReport(ctx context.Context, in *PolishReportRequest, opts ...grpc.CallOption) (*PolishReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PolishReportResponse)
	err := c.cc.Invoke(ctx, ReportService_PolishReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReportServiceServer interface {
	...
	// 润色报告
	PolishReport(context.Context, *PolishReportRequest) (*PolishReportResponse, error)
	// 导出报告
...
func (UnimplementedReportServiceServer) PolishReport(context.Context, *PolishReportRequest) (*PolishReportResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PolishReport not implemented")
}
...
func _ReportService_PolishReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PolishReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReportServiceServer).PolishReport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReportService_PolishReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).PolishReport(ctx, req.(*PolishReportRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "todoing.ReportService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PolishReport",
			Handler:    _ReportService_PolishReport_Handler,
		},
		{
